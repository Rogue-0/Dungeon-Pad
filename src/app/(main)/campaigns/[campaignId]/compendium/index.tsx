...
export default function CampaignCompendiumScreen() {
  ...
  const filteredItems = useMemo(() => {
    let items = MOCK_COMPENDIUM_ITEMS.filter((item) => item.campaignId === campaignId);
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.viewingLabel}>
        Viewing: {campaign?.name ?? 'Campaign'}
      </Text>
      ...
      <View style={styles.controlsRow}>
        ...
        <View style={styles.controlField}>
          ...
          <View style={styles.controlBox}>
            <Text style={styles.controlValue}>{campaign?.name ?? 'Campaign'}</Text>
